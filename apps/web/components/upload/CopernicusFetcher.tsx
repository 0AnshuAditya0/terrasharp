...
export default function CopernicusFetcher() {
  ...
  return (
    <form
      ...
      className="surface-card space-y-6 p-7"
    >
      <div className="grid grid-cols-2 gap-4">
        <div className="space-y-1">
          ...
          <input
            ...
            className="w-full rounded-md border border-input bg-background px-3 py-3 text-sm focus:outline-none focus:ring-1 focus:ring-primary"
            required
          />
        </div>
        <div className="space-y-1">
      ...
      <button
        ...
        disabled={loading}
        id="cop-submit"
        className="w-full bg-primary text-black rounded-md px-4 py-3 text-sm font-semibold hover:-translate-y-0.5 hover:bg-primary/90 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
      >
